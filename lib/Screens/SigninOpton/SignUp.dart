...
import 'package:trainingtalenew/Screens/SigninOpton/Otp_verification_Email.dart';
...
class _SignUPState extends State<SignUP> {
  ...
  Widget build(BuildContext context) {
    ...
    final sendOtp = ElevatedButton.icon(
      style: ElevatedButton.styleFrom(
        minimumSize: Size.fromHeight(50),
      ),
      icon: Icon(Icons.arrow_forward_ios_sharp, size: 32),
      label: Text(
        'Send OTP',
    ...
    final verifyOtp = ElevatedButton.icon(
      style: ElevatedButton.styleFrom(
